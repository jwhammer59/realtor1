      ...
      <div className="flex flex-col sm:flex-row justify-around">
        <div className="mb-2">
          <button
            ...
            className="w-full text-lg font-medium uppercase px-4 py-2 rounded border text-blue-600 border-blue-600 hover:bg-blue-600 hover:text-white shadow-md hover:shadow-lg cursor-pointer transition duration-150 ease-in-out"
          >
        ...
        <div className="mb-2">
          <button className="w-full text-green-600 text-lg font-medium uppercase px-4 py-2 rounded hover:text-white hover:bg-green-600 border border-green-600 shadow-md hover:shadow-lg cursor-pointer transition duration-150 ease-in-out">
            <span className="flex justify-center items-center">
              Load All Items
